...
int main()
{
    ...
    fp_input = fopen( "D:\\Proga RTF\\Labs\\lab5.2\\data.txt" , "r" );
    ...
    output = fopen( "D:\\Proga RTF\\Labs\\lab5.2\\table.txt" , "w" );
...
t1 = x1;
    ...
    outbin = fopen( "D:\\Proga RTF\\Labs\\lab5.2\\binar.bin" , "wb" );
...
t2 = x1;
    ...
    outbin = fopen( "D:\\Proga RTF\\Labs\\lab5.2\\binar.bin" , "rb" );
